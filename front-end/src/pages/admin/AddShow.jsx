        ...
        <Title txtOne="Add" txtTwo="Shows"/>
           ...
           <div className='overflow-x-auto no-scrollbar pb-4'>
            ...
            <div className="flex flex-wrap gap-4 mt-4 w-max">
                 {
                    nowPlayingMovie.map((data,index)=>(
                        ...
                        } onClick={()=>setSelectedMovie(data._id)}>
                             <div className='relative rounded-lg overflow-hidden'>
                              <img src={data.poster_path} alt=""  className='w-full object-cover brightness-90'/>
...

            {
               ...
               <button className='bg-pink-500 text-white px-8 py-2 mt-6 rounded-lg cursor-pinter'>Add Show</button>
